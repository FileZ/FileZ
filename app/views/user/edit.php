...
<section class="new-file fz-modal">
  <form method="POST" enctype="multipart/form-data" action="<?php echo url_for ('/admin/users') ?>" id="new_user-form">
  <div id="username">
  ...
  <ul id="options">
    <li id="is_admin">
      <input type="checkbox" name="is_admin" id="is_admin" value="" <?php echo ($user->is_admin==1) ? "checked" : "" ?> />
  ...
  <div id="upload">
    <input type="submit" id="start-new_user" name="new_user" class="awesome blue large" value="&raquo; <?php echo __('Update') ?>" />
  </div>
  </form>
</section>
